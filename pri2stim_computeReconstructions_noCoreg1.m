function pri2stim_computeReconstructions_noCoreg1(subj, VOIs,hex_size)
%
...
%
% updated from pri2stim_computeReconstructions_posCoreg1.m
% - used to generate 'raw' data, matched to images of stimuli, mainly for
%   figure-making purposes
...
%         tu = unique(chan.tpts);
%         if length(tu)>1
%             chan.conds = chan.conds(chan.tpts==tu(1),:);
%         end
        ...
        for ii = 1:2   % TR, TN
            ...
            %for tt = 1:n_trials
                ...
                [this_rfX, this_rfY] = pol2cart(rfT,rfR);
...
%                 
        ...
        % save file
        fn2s = sprintf('%spri2stim_recons/%s_%s_hex%i_no_coreg1.mat',root,subj{ss},VOIs{vv},hex_size);
        fprintf('saving to %s...\n',fn2s);
